        ...
        <div className="container-custom">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">
              About <span className="gradient-text">Jay Ambe</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Building dreams and creating landmarks for over 25 years. 
              We are committed to excellence, innovation, and sustainable construction practices.
            </p>
          </motion.div>
        </div>
      </section>
